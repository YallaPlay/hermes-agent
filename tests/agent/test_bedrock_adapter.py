...
class TestBedrockContextLength:
    ...
    def test_claude_opus_4_8_is_1m(self):
        ...
        # Must not collide down into the generic opus-4 (200K) entry.
        # (Opus 4.6/4.7 are 1M GA as of April 2026 per upstream's table.)
        assert get_bedrock_context_length("global.anthropic.claude-opus-4-6") == 1_000_000
