        ...
        try:
            ...
            for _msg_idx in range(_scan_start, len(messages)):
                ...
                _batch_rows.append({
                    ...
                    # Fork: use the image-ref-merged metadata for THIS row —
                    # msg.get() alone would drop refs when the live-dict stamp
                    # was skipped (see the content-parts branch above).
